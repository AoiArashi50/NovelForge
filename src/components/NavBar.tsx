...
import { Home, BookOpen, PenTool, Library, Database, Search, X } from "lucide-react"
          ...
          {searchOpen ? (
            <form onSubmit={handleSearch} className="flex items-center gap-2">
              <input
                ...
                placeholder="搜索小说..."
                className="px-3 py-1.5 rounded-full bg-white/5 border border-white/10 focus:border-amber-500 outline-none text-sm text-[#FDFBF5] w-48 placeholder:text-white/40"
              />
